# YouTube Video Links Checklist - Standard Package

Please upload each video to YouTube (set as **Unlisted**) and fill in the YouTube link or video ID for each PDF below.

**Instructions:**
- Upload video to YouTube
- Set video to **Unlisted** (not Private)
- Copy the YouTube link (e.g., `https://www.youtube.com/watch?v=VIDEO_ID`)
- Paste it in the space provided below

---

## 📅 DAY 1 (8 videos needed)
...
- [ ] **Summary of Rules H1 to 3**
  - YouTube Link: _________________________________

- [ ] **Part One - Alertness on the Road**
  - YouTube Link: _________________________________
...
Please send this filled checklist back, and I'll update the app with all the YouTube video links!
